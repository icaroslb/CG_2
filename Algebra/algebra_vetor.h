...
template <class T> Vec_3<T> vetor_reflexao ( const Vec_3<T> &vetor, const Vec_3<T> &normal );
template <class T> Vec_3<T> vetor_refracao ( const Vec_3<T> &vetor, const Vec_3<T> &normal, T indice_meio_1, T indice_meio_2 );
